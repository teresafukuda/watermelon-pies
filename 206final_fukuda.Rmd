...
rownames(ucsb_climate_a)<- c("african_american","american_indian_alaskan","asian_asianam","hispanic_latino","middleeast_sasian_safrican","pac_islander","white")
...
campusclimate_table <- kable(campusclimate_prop)
campusclimate_table
